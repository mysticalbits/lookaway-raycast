import { ActionPanel, Action, List, Toast, Form, useNavigation, Icon, showToast } from "@raycast/api";
...
function CustomDurationForm() {
  ...
  return (
    <Form
      actions={(
        <ActionPanel>
          <Action.SubmitForm title="Pause Timer" onSubmit={handleSubmit} />
        </ActionPanel>
      )}
    >
      <Form.TextField
...
export default function Command() {
  ...
  return (
    <List navigationTitle="Pause Timer Temporarily">
